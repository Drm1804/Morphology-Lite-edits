 ...
 */    
	...
	$wp_customize->add_control( 'load_fontawesome', array(
	 ...
	 // Setting group to show the edit links 
	  ...
	  // Setting to show top bit of left/right sidebar page templates
	  $wp_customize->add_setting( 'show_page_top',  array(
		  'default' => 1,
		  'sanitize_callback' => 'morphology_lite_sanitize_checkbox',
		) );  
	  $wp_customize->add_control( 'show_page_top', array(
		'type'     => 'checkbox',
		'priority' => 6,
		'label'    => esc_html__( 'Show extended top for Left & Right Sidebar page templates', 'morphology-lite' ),
		'description' => esc_html__( 'Show Banner and Top widgets on the Left & Right Sidebar page templates.', 'morphology-lite' ),
		'section'  => 'site_options',
	  ) );	
